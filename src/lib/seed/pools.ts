...
export const ITEM_CATALOG: SeedItem[] = [
  ...
  { name: 'Furnace Oil', description: 'Heavy fuel oil for furnaces', hsnCode: '27101950', category: 'OIL_FUEL', group: 'Industrial Fuel', unit: 'KL', minRate: 42000, maxRate: 54000, gst: 18, spec: 'Viscosity 180 cSt' },
  ...
  { name: 'Industrial Lubricant Drum', description: 'Industrial grade — 210L drum', hsnCode: '27101981', category: 'LUBRICANT', group: 'Lubricants', unit: 'KL', minRate: 35000, maxRate: 120000, gst: 18, spec: '210 litre sealed drum' },
  { name: 'Greases — Lithium', description: 'Lithium complex grease', hsnCode: '27101981', category: 'LUBRICANT', group: 'Lubricants', unit: 'L', minRate: 160, maxRate: 290, gst: 18, spec: 'NLGI Grade 3' },
  { name: 'MEG', description: 'Mono Ethylene Glycol — Industrial Grade', hsnCode: '29053100', category: 'GLYCOL', group: 'Glycols', unit: 'L', minRate: 58, maxRate: 72, gst: 18, spec: 'Purity ≥ 99.8%, IS 12346' },
  { name: 'DEG', description: 'Di Ethylene Glycol', hsnCode: '29094100', category: 'GLYCOL', group: 'Glycols', unit: 'L', minRate: 62, maxRate: 78, gst: 18, spec: 'Purity ≥ 99.5%' },
  { name: 'TEG', description: 'Tri Ethylene Glycol', hsnCode: '29094400', category: 'GLYCOL', group: 'Glycols', unit: 'L', minRate: 85, maxRate: 105, gst: 18, spec: 'Purity ≥ 99.5%' },
  { name: 'Propylene Glycol', description: 'Mono Propylene Glycol — USP', hsnCode: '29053200', category: 'GLYCOL', group: 'Glycols', unit: 'L', minRate: 95, maxRate: 135, gst: 18, spec: 'USP/IP grade' },
  { name: 'Toluene', description: 'Industrial solvent — Toluene', hsnCode: '29023000', category: 'SOLVENT', group: 'Solvents', unit: 'L', minRate: 65, maxRate: 88, gst: 18, spec: 'Purity ≥ 99.5%' },
  { name: 'Benzene', description: 'Aromatic solvent — Benzene', hsnCode: '29022000', category: 'SOLVENT', group: 'Solvents', unit: 'L', minRate: 55, maxRate: 78, gst: 18, spec: 'Purity ≥ 99.9%' },
  { name: 'Mixed Xylene', description: 'Mixed Xylene isomers', hsnCode: '29024400', category: 'SOLVENT', group: 'Solvents', unit: 'L', minRate: 70, maxRate: 92, gst: 18, spec: 'Industrial grade' },
  { name: 'MDC', description: 'Methylene Dichloride', hsnCode: '29031200', category: 'SOLVENT', group: 'Solvents', unit: 'L', minRate: 85, maxRate: 115, gst: 18, spec: 'Purity ≥ 99.9%' },
  { name: 'Acetone', description: 'Industrial solvent — Acetone', hsnCode: '29141100', category: 'SOLVENT', group: 'Solvents', unit: 'L', minRate: 72, maxRate: 98, gst: 18, spec: 'Purity ≥ 99.5%' },
  { name: 'IPA', description: 'Iso Propyl Alcohol', hsnCode: '29051220', category: 'SOLVENT', group: 'Solvents', unit: 'L', minRate: 88, maxRate: 120, gst: 18, spec: 'Purity ≥ 99.7%' },
  { name: 'HDPE Reprocessed', description: 'HDPE granules — reprocessed', hsnCode: '39012000', category: 'PLASTIC_GRANULE', group: 'Granules', unit: 'KL', minRate: 78000, maxRate: 105000, gst: 18, spec: 'Blow grade, reprocessed' },
  { name: 'HDPE Virgin 5502', description: 'HDPE Blow 5502 — virgin', hsnCode: '39012000', category: 'PLASTIC_GRANULE', group: 'Granules', unit: 'KL', minRate: 95000, maxRate: 125000, gst: 18, spec: 'Blow grade 5502, virgin' },
  { name: 'LDPE Virgin 1020', description: 'LDPE 1020 — virgin', hsnCode: '39011010', category: 'PLASTIC_GRANULE', group: 'Granules', unit: 'KL', minRate: 110000, maxRate: 140000, gst: 18, spec: 'Film grade 1020' },
  { name: 'PP H110MA', description: 'Polypropylene H110MA', hsnCode: '39021000', category: 'PLASTIC_GRANULE', group: 'Granules', unit: 'KL', minRate: 95000, maxRate: 118000, gst: 18, spec: 'Homopolymer, injection' },
  { name: 'LLDPE', description: 'Linear Low Density Polyethylene', hsnCode: '39014010', category: 'PLASTIC_GRANULE', group: 'Granules', unit: 'KL', minRate: 98000, maxRate: 122000, gst: 18, spec: 'Film grade' },
  { name: 'LAB SA', description: 'Linear Alkyl Benzene — Sulphonic Acid', hsnCode: '34021100', category: 'SPECIALTY', group: 'Specialty Chemicals', unit: 'L', minRate: 72, maxRate: 95, gst: 18, spec: 'Active matter ≥ 96%' },
  { name: 'Unsaturated Polyester Resin', description: 'UPR — general purpose', hsnCode: '39073100', category: 'SPECIALTY', group: 'Specialty Chemicals', unit: 'KL', minRate: 105000, maxRate: 140000, gst: 18, spec: 'GP grade, orthophthalic' },
  { name: 'White Oil', description: 'Light liquid paraffin — pharma', hsnCode: '27101990', category: 'SPECIALTY', group: 'Specialty Chemicals', unit: 'L', minRate: 110, maxRate: 165, gst: 18, spec: 'IP/USP grade' },
  { name: 'Wax — Paraffin', description: 'Fully refined paraffin wax', hsnCode: '27122090', category: 'SPECIALTY', group: 'Specialty Chemicals', unit: 'L', minRate: 95, maxRate: 145, gst: 18, spec: 'Melting point 58-60°C' },
];
